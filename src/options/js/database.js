import { CATEGORY_DATABASE_NAME, CATEGORY_DATABASE_VERSION, CATEGORY_OBJECT_STORE_NAME, CATEGORY_NAME, CATEGORY_COLOR, CATEGORY_SHORTCUT } from '../../database/constants.js';
